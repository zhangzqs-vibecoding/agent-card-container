...
| Cloud structured logging deployment | Static Linux binary plus systemd/journald assertions on Ubuntu 24.04 x86_64 | PASS | SHA-256 `5da02e920d5db839db71d597d4919c7329db0fee07a0333d3fbdcbab32aead6a`; service remained active; health 200, authenticated cards 200, unauthenticated cards 401, generation create 201 and confirm 200 emitted correlated JSON logs; generation/model failure events included model name and stable error kind; automated assertions proved the access token and test prompt absent from journald |
